<svg style="height: 130px;" class="lds-microsoft" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><g><circle cx="73.801" cy="68.263" fill="#fdfdfd" r="3">
...
</circle><circle cx="68.263" cy="73.801" fill="#85a2b6" r="3">
...
</circle><circle cx="61.481" cy="77.716" fill="#bbcedd" r="3">
...
</circle><circle cx="53.916" cy="79.743" fill="#dce4eb" r="3">
...
</circle><circle cx="46.084" cy="79.743" fill="#a00d1e" r="3">
...
</circle><circle cx="38.519" cy="77.716" fill="#be5960" r="3">
...
</circle><circle cx="31.737" cy="73.801" fill="#d69293" r="3">
...
</circle><circle cx="26.199" cy="68.263" fill="#fdfdfd" r="3">
