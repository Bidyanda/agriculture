    ...
    <div class="col-md-offset-2 col-md-8">
		<div class="steps">
			...
			<div class="stepscover">
				<?= Html::a('<div>Form A1</div>', '#!', ['class'=>'step '.($active==1?'active':'').' '.($step>1?'completed':'incomplete'), 'data-toggle'=>'tooltip', 'title'=>'Phone Number Verification']) ?>
			</div>
			<div class="stepscover">
				<?= Html::a('<div>File Uploads</div>', (($active>=2) ? ['/site/personal'] : '#!'), ['class'=>'step '.($active==2?'active':'').' '.($step>2?'completed':'incomplete'), 'data-toggle'=>'tooltip', 'title'=>'Personal Details']) ?>
			</div>
			<div class="stepscover">
				<?= Html::a('<div>Status</div>', (($active>=3) ? ['/site/academic'] : '#!'), ['class'=>'step '.($active==3?'active':'incomplete'), 'data-toggle'=>'tooltip', 'title'=>'Social Details & Trade Selection']) ?>
			</div>
		</div>
	</div>
</div>
